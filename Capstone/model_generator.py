...
def model_generator_UNet():
    ...
    # Encoder
    layer_e1 = Conv2D(64, (4, 4), strides=(2, 2), padding='same')(layer_i)

    layer_e2 = LeakyReLU(alpha=0.2)(layer_e1)
    layer_e2 = Conv2D(128, (4, 4), strides=(2, 2), padding='same')(layer_e2)
    layer_e2 = BatchNormalization()(layer_e2)

    layer_e3 = LeakyReLU(alpha=0.2)(layer_e2)
    layer_e3 = Conv2D(256, (4, 4), strides=(2, 2), padding='same')(layer_e3)
    layer_e3 = BatchNormalization()(layer_e3)

    layer_e4 = LeakyReLU(alpha=0.2)(layer_e3)
    layer_e4 = Conv2D(512, (4, 4), strides=(2, 2), padding='same')(layer_e4)
    layer_e4 = BatchNormalization()(layer_e4)

    layer_e5 = LeakyReLU(alpha=0.2)(layer_e4)
    layer_e5 = Conv2D(512, (4, 4), strides=(2, 2), padding='same')(layer_e5)
    layer_e5 = BatchNormalization()(layer_e5)

    layer_e6 = LeakyReLU(alpha=0.2)(layer_e5)
    layer_e6 = Conv2D(512, (4, 4), strides=(2, 2), padding='same')(layer_e6)
    layer_e6 = BatchNormalization()(layer_e6)

    layer_e7 = LeakyReLU(alpha=0.2)(layer_e6)
    layer_e7 = Conv2D(512, (4, 4), strides=(2, 2), padding='same')(layer_e7)
    layer_e7 = BatchNormalization()(layer_e7)

    layer_e8 = LeakyReLU(alpha=0.2)(layer_e7)
    layer_e8 = Conv2D(512, (4, 4), strides=(2, 2), padding='same')(layer_e8)

    # Decoder
    layer_d1 = Activation('relu')(layer_e8)
    layer_d1 = Conv2DTranspose(512, (4, 4), strides=(2, 2), padding='same')(layer_d1)
    ...
    layer_d2 = Conv2DTranspose(512, (4, 4), strides=(2, 2), padding='same')(layer_d2)
    ...
    layer_d3 = Conv2DTranspose(512, (4, 4), strides=(2, 2), padding='same')(layer_d3)
    layer_d3 = BatchNormalization()(layer_d3)
    ...
    layer_d4 = Conv2DTranspose(512, (4, 4), strides=(2, 2), padding='same')(layer_d4)
    layer_d4 = BatchNormalization()(layer_d4)
    layer_d4 = Concatenate()([layer_d4, layer_e4]) # Residual connections

    layer_d5 = Activation('relu')(layer_d4)
    layer_d5 = Conv2DTranspose(256, (4, 4), strides=(2, 2), padding='same')(layer_d5)
    layer_d5 = BatchNormalization()(layer_d5)
    layer_d5 = Concatenate()([layer_d5, layer_e3]) # Residual connections

    layer_d6 = Activation('relu')(layer_d5)
    layer_d6 = Conv2DTranspose(128, (4, 4), strides=(2, 2), padding='same')(layer_d6)
    layer_d6 = BatchNormalization()(layer_d6)
    layer_d6 = Concatenate()([layer_d6, layer_e2]) # Residual connections

    layer_d7 = Activation('relu')(layer_d6)
    layer_d7 = Conv2DTranspose(64, (4, 4), strides=(2, 2), padding='same')(layer_d7)
    layer_d7 = BatchNormalization()(layer_d7)
    layer_d7 = Concatenate()([layer_d7, layer_e1]) # Residual connections

    layer_d8 = Activation('relu')(layer_d7)
    layer_d8 = Conv2DTranspose(3, (4, 4), strides=(2, 2), padding='same')(layer_d8)
